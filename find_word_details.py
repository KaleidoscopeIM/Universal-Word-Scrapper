...
def write_with_remove_redundancy(word_string, word):
    ...
    file = open(r"D:\Video Work Area\GRE WORDS APP\data\scrapped\WordsList.json", "r+")
    redundant = False
    redundant_count = 1
    ...
    for obj in all_obj:
        if word == obj["WORD"] and obj["WORD"] != "":
            ...
            if redundant_count == 1:
                ...
                print("Found multiple entries in temp word details .. "
                      "updating values to empty all data.....total redundancy..:" + str(redundant_count))
                obj["WORD"] = ""
                obj["TYPE"] = ""
                obj["MEANING"] = ""
                obj["SENTENCE"] = ""
